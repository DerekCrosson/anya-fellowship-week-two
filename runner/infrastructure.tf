...
resource "aws_secretsmanager_secret" "GITHUB_PERSONAL_ACCESS_TOKEN" {
  name = "${var.PREFIX}-GITHUB_PERSONAL_ACCESS_TOKEN"
}

resource "aws_secretsmanager_secret_version" "GITHUB_PERSONAL_ACCESS_TOKEN_version" {
...
resource "aws_secretsmanager_secret" "GITHUB_ORGANIZATION" {
  name = "${var.PREFIX}-GITHUB_ORGANIZATION"
}

resource "aws_secretsmanager_secret_version" "GITHUB_ORGANIZATION_version" {
...
resource "aws_secretsmanager_secret" "GITHUB_REPO" {
  name = "${var.PREFIX}-GITHUB_REPO"
}

resource "aws_secretsmanager_secret_version" "GITHUB_REPO_version" {
  ...
  [
    {
      ...
      "secrets": [{
        "name": "PAT",
        "valueFrom": "${aws_secretsmanager_secret.GITHUB_PERSONAL_ACCESS_TOKEN.arn}"
      },
      {
        "name": "ORG",
        "valueFrom": "${aws_secretsmanager_secret.GITHUB_ORGANIZATION.arn}"
      },
      {
        "name": "REPO",
